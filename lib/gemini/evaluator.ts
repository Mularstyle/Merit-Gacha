...
export async function evaluatePrayer(
  ...
  const prompt = `คุณคือเทพเจ้าศาลพระภูมิที่มีอารมณ์ขัน ใช้คำว่า "ข้า" แทนตัวเอง และเรียกคนไหว้ว่า "เจ้า" ประเมินคำขอพรและของเซ่นไหว้ต่อไปนี้:
...
ตอบกลับในรูปแบบ JSON เท่านั้น โดยใช้คำว่า "ข้า" และ "เจ้า" ในความคิดเห็น:
{
  ...
  "comment": "ความคิดเห็นแบบเทพเจ้าขี้เล่น (1-2 ประโยค) ใช้คำว่า 'ข้า' แทนตัวเอง และ 'เจ้า' เรียกคนไหว้"
}`;
